# PRD: HVAC Helper Pro – Handheld Troubleshooting Device (Archived)

> [!WARNING]
> This document is an **archived draft** (V1, dated May 18, 2026). It has been superseded by the current product requirements document: [PRD.md](file:///c:/Users/joshu/projects/hvac-helper-tool/docs/PRD.md).
