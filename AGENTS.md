...
> **Purpose.** This file is loaded automatically at the start of every session in Codex, Antigravity, Cursor, and Windsurf. It tells the orchestrator and any activated agent **which skill or agent to call for what**, and just as importantly, **which ones to leave alone for this project**.
>
